...
function App() {
  ...
  useEffect(() => {
    async function getMatchups() {  
      const res = await fetch("https://ray-mak.github.io/betstats_scraper/ufc_fn_nicolau_perez.json")
      const data = await res.json()
      setMatchups(data)
    }
    async function getFighterStats() {
      const res = await fetch("https://ray-mak.github.io/betstats_scraper/fighter_stats_nicolau_perez.json")
      const data = await res.json()
      setFighterStats(data)
    }
    async function getUserStats() {
      const res = await fetch("https://ray-mak.github.io/betstats_scraper/ufc_fn_nicolau_perez_users.json")
      const data = await res.json()
      setUserStats(data)
    }
    getFighterStats()
